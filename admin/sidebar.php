    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview menu-open">
            <h5 class="pt-2 pb-2" style="color:white;">Job SECTION</h5>
			</li>
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="add-job.php" class="nav-link <?php if($a==7){ echo 'active'; }?>">
               <i class="fa fa-plus nav-icon"></i>
              <p>
                Add Job
              </p>
      ...
      <li class="nav-item has-treeview menu-open">
            <a href="view-job.php" class="nav-link <?php if($a==8){ echo 'active'; }?>">
               <i class="fa fa-eye nav-icon"></i>
              <p>
                View Job
              </p>
